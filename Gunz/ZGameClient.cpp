...
//	gid = MMUG_DEVELOPER;
	...
	if(bSpUser)	// 특수유저
	{
        ...
        {
         case 255 :
        wsprintf(szText, "[Administrator] %s : %s", szName , szChat);
            break; 
        case 254:
        wsprintf(szText, "[Developer] %s : %s", szName , szChat);
            break;
        case 251:
        wsprintf(szText, "[Root] %s : %s", szName , szChat);
            break;
        case 250:
        wsprintf(szText, "[OP] %s : %s", szName , szChat);
            break;			
		case 252:
        wsprintf(szText, "[GM] %s : %s", szName , szChat);
            break;
        case 10:
        ...
        wsprintf(szText, "[VIP] %s : %s", szName , szChat);
            break;				
        case 5:
        wsprintf(szText, "[Mute] %s : %s", szName , szChat);
            break;
        }
...
//	gid = MMUG_DEVELOPER;
	...
	if(bSpUser)	// 특수유저
	{
        ...
        {
        case 255 :
        wsprintf(szText, "[Administrator] %s : %s", pObjCache->GetName() , szChat);
            break; 
        case 254:
        wsprintf(szText, "[Developer] %s : %s", pObjCache->GetName() , szChat);
            break;
        case 251:
        wsprintf(szText, "[Root] %s : %s", pObjCache->GetName() , szChat);
            break;
        case 250:
        wsprintf(szText, "[OP] %s : %s", pObjCache->GetName() , szChat);
            break;			
		case 252:
        wsprintf(szText, "[GM] %s : %s", pObjCache->GetName() , szChat);
            break;
        case 10:
        ...
        wsprintf(szText, "[VIP] %s : %s", pObjCache->GetName() , szChat);
            break;				
        case 5:
        wsprintf(szText, "[Mute] %s : %s", pObjCache->GetName() , szChat);
            break;
        }
