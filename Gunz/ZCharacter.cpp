...
void ZCharacter::ChangeLowPolyModel()
{
	...
	// Custom: No low poly models, ugly as fck.
...
bool ZCharacter::IsRootName()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_ROOT)
		return true;
	return false;
}
bool ZCharacter::IsOpName()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_OP)
		return true;
	return false;
}
...
bool ZCharacter::IsMuteName()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_CHAT_LIMITED)
		return true;
	return false;
}
bool ZCharacter::IsVipName()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP)
		return true;
	return false;
}
//VIP
...
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP8)
		return true;
	return false;
}
bool ZCharacter::IsVIP9Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP9)
		return true;
	return false;
}
bool ZCharacter::IsVIP10Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP10)
		return true;
	return false;
}
bool ZCharacter::IsVIP11Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP11)
		return true;
	return false;
}
bool ZCharacter::IsVIP12Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP12)
		return true;
	return false;
}
bool ZCharacter::IsVIP13Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP13)
		return true;
	return false;
}
bool ZCharacter::IsVIP14Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP14)
		return true;
	return false;
}
bool ZCharacter::IsVIP15Name()
{
	if(m_MInitialInfo.Ref().nUGradeID == MMUG_VIP15)
		return true;
	return false;
}
//
