...
// Edit nho mat khau, fuction khai bao ham
char* cifra(char*);
char* descifra(char*);
...
//	SetListenerWidget("MapList_Caller", ZGetStageMapListCallerListener());
	...
	*/
	...
	// 동의 관련ZGameInterface::~ZGameInterfac
...
void ZGameInterface::OnLoginCreate(void)
{
	...
	MWidget* pWidgetz = m_IDLResource.FindWidget("LoginPassword");	// Edit nho mat khau
	if(pWidget)
	{
		char buffer[256];
...
//					_snprintf( szServName, 127, "server%d(dead)", pss->m_nServerID );
	...
	// Fix hien thi dung so nguoi online tren server
...
// Edit nho mat khau, fucntion khai bao ham

char *alfabeto="abcdefghijklmn?pqrstuvwxyz";
char *cifrado ="DEFGHIJKLMN?PQRSTUVWXYZABC";
