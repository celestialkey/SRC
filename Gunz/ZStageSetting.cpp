...
// 최대인원
#define STAGESETTING_MAXPLAYER_MAX		9
...
// Edit sua so luong nguoi tham gia game
	{{1, "1"}, {2, "2"}, {4, "4"}, {6, "6"}, {8, "8"}, {10, "10"}, {12, "12"}, {14, "14"}, {16, "16"} };

// 라운드
#define STAGESETTING_MAXROUND_MAX		4
