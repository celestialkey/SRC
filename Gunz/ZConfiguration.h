...
struct ZCONFIG_ETC{
	...
	bool        bfps;		// Edit ShowFPS
	bool        bhpap;		// Edit ShowHPAP
};
...
#define ZTOK_ETC_FPS				"FPS"		// Edit ShowFPS
#define ZTOK_ETC_HPAP				"HPAP"		// Edit ShowFPS
...
#define Z_ETC_FPS      			(ZGetConfiguration()->GetEtc()->bfps)		// Edit ShowFPS
#define Z_ETC_HPAP      		(ZGetConfiguration()->GetEtc()->bhpap)		// Edit ShowHPAP
