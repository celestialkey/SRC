...
enum MMatchUserGradeID
{
	...
	MMUG_VIP			= 10,  // VIP
	MMUG_VIP1           = 200, //Cam - #FF8000
    MMUG_VIP2           = 201, //Vang - #FFFF00
    MMUG_VIP3           = 202, //HongDam - #FF0080
    MMUG_VIP4           = 203, //HongNhat - #FF00FF
    MMUG_VIP5           = 204, //Tim - #8000FF
    MMUG_VIP6           = 205, //XanhDuong - #48d1cc
    MMUG_VIP7         	= 206, //XanhDuongVua - #0080FF
    MMUG_VIP8         	= 207, //XanhDuongDam - #0000FF
    MMUG_VIP9	        = 208, //XanhLa - #86CB2C
    MMUG_VIP10          = 209, //XanhLaNhat - #12E29D
    MMUG_VIP11          = 210, //XanhLaDam - #2EC56E
	MMUG_VIP12	        = 211, //Nau - #5C1E08
    MMUG_VIP13			= 212, //Trang - #FFFFFF
    MMUG_VIP14          = 213, //Den - #000000
	MMUG_VIP15          = 214, //7Mau - #000000
...
inline bool IsAdminGrade(MMatchUserGradeID nGrade) 
{
	if ((nGrade == MMUG_EVENTMASTER) || 
		(nGrade == MMUG_ADMIN) || 
		(nGrade == MMUG_ROOT) ||	// Edit them quan tri
		(nGrade == MMUG_OP) ||
